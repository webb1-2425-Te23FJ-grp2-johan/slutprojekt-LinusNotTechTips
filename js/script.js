...
submitElement.addEventListener('click', async e=>{
     ...
     try {
          ...
          const {generationtime_ms} = weather;
          const {temperature_2m,relative_humidity_2m,is_day,wind_speed_10m} = weather.current;
          console.log(generationtime_ms);
          outputElement1.textContent = "Stad: " + weather.name;
